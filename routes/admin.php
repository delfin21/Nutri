...
Route::middleware(['auth:admin'])->prefix('admin')->name('admin.')->group(function () {
 ...
 Route::get('/verifications', [FarmerVerificationReviewController::class, 'index'])->name('verifications.index');
    ...
    Route::patch('/verifications/web/{id}/approve', [FarmerVerificationReviewController::class, 'approveWeb'])->name('verifications.approve.web');
    Route::patch('/verifications/web/{id}/reject', [FarmerVerificationReviewController::class, 'rejectWeb'])->name('verifications.reject.web');

    Route::patch('/verifications/mobile/{id}/approve', [FarmerVerificationReviewController::class, 'approveMobile'])->name('verifications.approve.mobile');
    Route::patch('/verifications/mobile/{id}/reject', [FarmerVerificationReviewController::class, 'rejectMobile'])->name('verifications.reject.mobile');
    // 🌟 Reviews & Ratings
